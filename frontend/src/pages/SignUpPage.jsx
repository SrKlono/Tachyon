...
function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-base-300 pt-32 lg:pt-15"> {/* TODO: remove mt-12 later*/}
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          <div className="flex flex-col items-center gap-2 group">
            ...
            >
              <img src="/icon.svg" className="size-6 text-base-content/60" />
            </div>
          ...
          <div className="text-center">
            <p className="text-base-content/60">
              ...
              <Link to="/login" className="link text-base-content no-underline">
                Login
              </Link>
            </p>
          </div>
